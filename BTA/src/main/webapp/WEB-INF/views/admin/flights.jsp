...
<html lang="en">
<head>
    <title>Administator Panel: flights</title>
    <meta charset="utf-8">
...
<div class="container">
    <table class="table">
        ...
        <c:forEach items="${flights}" var="flight" varStatus="counter">
            <tr>
                ...
                <td>${flight.time}</td>
                <td><a href="editFlight?id=${flight.flightId}">Update</a></td>
                <td><a href="deleteflight?id=${flight.flightId}">Delete</a></td>

            </tr>
        </c:forEach>
    </table>
    <a class="btn btn-primary" href="addflight" role="button">add flight</a>
</div>
<div class="side_menu">
