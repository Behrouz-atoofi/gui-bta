...
<html lang="en">
<head>
    <title>Administator Panel : Edit Customers </title>
    <meta charset="utf-8">
...
<form action="updateCustomer">
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="phoneNumber" name="phoneNumber" value="${customer.phoneNumber}" >
    </div>

    <div class="form-group">
        <label for="billingAddress">billing Address</label>
        <input type="text" class="form-control" id="billingAddress" name="billingAddress" value="${customer.billing_address}">
    </div>
