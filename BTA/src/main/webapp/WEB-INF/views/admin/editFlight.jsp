...
<h1 class="page_title"> Edit Flight </h1>
<form action="updateFlight">
    <center>
        <div class="col-lg-4 col-lg-offset-4">
                <div class="form-group">
                    <label for="flightId">flight ID</label>
                    <input type="text" class="form-control" id="flightId" name="id" value="${flight.flightId}" readonly>
                </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="quantity" name="quantity"  value="${flight.quantity}">
    </div>
